...
from Review_Automation import  Start_Project_Review ,Cancel ,GetUserDetails , Project_Count_Update
...
def handle_review(data):
    ...
    def send_update(msg):
        socketio.emit("Project_Count_Update",Project_Count_Update())
        socketio.emit("User_Details",GetUserDetails())
